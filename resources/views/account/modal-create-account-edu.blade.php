<div id="modal-form1" class="modal fade modal-no-padding" aria-hidden="true">
                ...
                <div class="popup-container p-b-25">
                    ...
                    <form method="post" id="formEducation" action="" class="">
                        <div class="form-group m-b-20">
                            ...
                            <input type="text" placeholder="Trường học" class="form-control" id="school" name="school">
                            <div class="error-create-account-edu error_school"></div>
                        </div>
                        <div class="form-group m-b-20">
                            <label class="m-b-6">Ngành nghề học<sup>*</sup></label>
                            <input type="text" placeholder="Ngành nghề học" class="form-control" id="filed_study" name="filed_study">
                            <div class="error-create-account-edu error_filed_study"></div>
                        </div>
                        <div class="form-group m-b-20">
                            <label class="m-b-6">Bằng cấp<sup>*</sup></label>
                            <div class="select-wrapper">
                                <select id="degree" name="degree" data-placeholder="Chọn chức vụ ..." class="chosen-select primary-select" tabindex="2">
                        ...
                        <div class="popup-btn-container tar">
                            <div data-id="{{$account->id}}" class="button-primary" id="btnEduAccount" type="submit">Lưu lại</div>
                        </div>
                    </form>
