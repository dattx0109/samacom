    ...
    <nav class="navbar navbar-default navbar-fixed-top header-navbar" role="navigation">
        ...
        @if(session()->has('user'))
                        ...
                        <div class="dropdown-content">
                            <div class="dropdown-inner dropdown-inner--max">
                                ...
                                <div class="dropdown-bottom">
                                    ...
                                    <a href="{{url('/change-password')}}"><i class="icon-unlock"></i>Đổi mật khẩu</a>
            ...
            <ul class="menu-pc-auth display-flex-wrap aic">
                ...
                <li>
                    <a href="{{url('/login')}}" class="button-primary" data-toggle="tooltip" data-placement="top" title="Điều khoản và chính sách">Đăng nhập</a>
                </li>
            </ul>
            @endif
        </div>
...
<footer>
    <div class="footer-home mobile-hidden">
        ...
        <ul class="f-link">
            <li>
                <a href="{{url('/dieu-khoan-chinh-sach')}}" data-toggle="tooltip" data-placement="top" title="Điều khoản và chính sách">Điều khoản và chính sách</a>
            </li>
        </ul>
        <div class="footer-right">
            <ul class="f-link">
                <li>
                    <a href="http://beta-ref.samacom.com.vn" data-toggle="tooltip" data-placement="top" title="Dành cho cộng tác viên"><i class="icon-user-2"></i>Cộng tác viên</a>
                </li>
                <li>
                    <a href="http://beta-employer.samacom.com.vn/dich-vu" data-toggle="tooltip" data-placement="top" title="Dành cho nhà tuyển dụng"><i class="icon-building-01"></i>Nhà tuyển dụng</a>
                </li>tuyển
            </ul>
            <ul class="footer-social">
                <li>
                    <a href="https://www.facebook.com/samacomvietnam/" target="_blank" data-toggle="tooltip" data-placement="top" title="Link Facebook"><i class="fa fa-facebook"></i></a>
                </li>
                <li>
                    <a href="https://www.linkedin.com/company/samacomvn/" target="_blank" data-toggle="tooltip" data-placement="top" title="Link linkedin"><i class="fa fa-linkedin"></i></a>
                </li>
{{--                <li>--}}
        ...
        <div class="footer-bottom">
            <div class="footer-copy">
                ...
                <ul class="footer-social mobile-show m-t-10 w100">
                    <li>
                        <a target="_blank" href="https://www.facebook.com/samacomvietnam/" data-toggle="tooltip" data-placement="top" title="Link Facebook"><i class="fa fa-facebook"></i></a>
                    </li>
                    <li>
                        <a target="_blank" href="https://www.linkedin.com/company/samacomvn/" data-toggle="tooltip" data-placement="top" title="Link linkedin"><i class="fa fa-linkedin"></i></a>
                    </li>
                </ul>
