...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/avatar.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/avatar.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (_components$props$pro = {
...
}, _defineProperty(_components$props$pro, "props", {
  profile: {
    type: Object
  },
  profile2: {
...
}), _defineProperty(_components$props$pro, "data", function data() {
  return {
    profileStatus: [{
      'id': 1,
      'name': 'Đang tìm việc'
...
}), _defineProperty(_components$props$pro, "methods", {
  ...
  checkRouterRedirect: function checkRouterRedirect() {
    var _this = this;
    ...
    if (redirectParam) {
      var listParam = redirectParam.split('/');
      var jobId = listParam[listParam.length - 1];
      this.jobId = jobId;
      axios.get('/job/' + jobId).then(function (data) {
        _this.jobRedirect = data.data;
      }); // let urlFull = redirectParam;

      this.urlRedirect = redirectParam;
    }
  },
  btnApplyJob: function btnApplyJob() {
    var _this2 = this;

    axios.get('/candidate-api/' + this.jobId).then(function (data) {
  ...
  onChangeStatus: function onChangeStatus() {
    ...
    this.isLoading = true;
    axios.post('/account/update-job-status', rawDataUpdate).then(function (data) {
  ...
  crop: function crop() {
    ...
    var rawDataUploadImage = {
      image: canvas.toDataURL()
    };
    this.isLoading = true;
    axios.post('/account/update-avatar', rawDataUploadImage).then(function (data) {
      _this4.isLoading = false;
      _this4.profile.accountDetail.avatar = data.data;
  ...
  uploadImage: function uploadImage(event) {
    ...
    $('#modalAvatar').modal('show'); // Reference to the DOM input element
...
}), _defineProperty(_components$props$pro, "mounted", function mounted() {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-base.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-base.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  methods: {
    fetchAllProvince: function fetchAllProvince() {
      ...
      axios.get('/api/list-province').then(function (data) {
        _this.province = data.data[0];
        _this.districtAll = data.data[1];
      });
    },
    getAllProfile: function getAllProfile() {},
    ...
    saveAccountDetail: function saveAccountDetail() {
      var _this2 = this;
      ...
      this.isLoading = true;
      axios.post('/api/update-account-detail', rawData).then(function (data) {
        axios.get('/account/get-list-profile-percentage').then(function (data) {
          _this2.isLoading = false;

          _this2.$emit('pass-data-to-paren', data.data); // this.profile = data.data;
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-character.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-character.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    listCharacter: function listCharacter() {
      return this.profile.characters;
    }
  },
  methods: {
    accountCharacter: function accountCharacter() {
      var dataAccountCharacter = this.profile.accCharacter;
      this.value = dataAccountCharacter;
    },
    saveCharacter: function saveCharacter(val) {
      var vm = [this.value]; // return;
      // let vm = this;
      // let id_character = val.id;

      axios.post('/api/update-account-character', vm).then(function (response) {// axios
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-desire.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-desire.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    saveDesire: function saveDesire() {
      var _this2 = this;
      ...
      this.errors = {};
      var rawData = this.desire;
      this.isLoading = true;
      axios.post('/account/add-account-wish', rawData).then(function (data) {
        axios.get('/account/get-list-profile-percentage').then(function (data) {
          _this2.$emit('pass-data-to-paren', data.data);
        });
        _this2.isLoading = false;
      });
    }
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-exp.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-exp.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteExp: function deleteExp(id) {
      var _this = this;

      this.isLoading = true;
      axios.post('/account/delete-exp/' + id).then(function (data) {
        axios.get('/account/get-list-exp').then(function (data) {
          _this.profile.accountExp = data.data;
          _this.isLoading = false;
        });
        axios.get('/account/get-list-profile-percentage').then(function (data) {
          _this.$emit('pass-data-to-paren', data.data);
        });
      });
    },
    clickCreateExp: function clickCreateExp() {
      this.resetFormEdit();
      $('#modal-form-create-exp').modal('show');
    },
    isFutureDate: function isFutureDate(date) {
      var dateStart = new Date(this.expStartTime);
      return date < dateStart;
    },
    isFutureDateEdit: function isFutureDateEdit(date) {
      var dateStart = new Date(this.editExp.expStartTime);
      return date < dateStart;
    },
    isDateTimeNow: function isDateTimeNow() {
    ...
    saveExpEdit: function saveExpEdit() {
      var _this2 = this;

      var objectNullValidate = !(Object.keys(this.validateEditForm()).length === 0 && this.validateEditForm().constructor === Object);
      ...
      this.errors = {};
      this.isLoading = true;
      axios.post('/account/update-exp/', rawDataCreateExp).then(function (data) {
        axios.get('/account/get-list-exp').then(function (data) {
          _this2.profile.accountExp = data.data;
          _this2.isLoading = false;
    ...
    saveExp: function saveExp() {
      ...
      this.errors = {};
      this.isLoading = true;
      axios.post('/account/add-exp', rawDataCreateExp).then(function (data) {
        $('#modal-form-create-exp').modal('hide');
        axios.get('/account/get-list-exp').then(function (data) {
          _this3.isLoading = false;
          _this3.profile.accountExp = data.data; // this.isLoading = false;
          // this.profile = data.data;
        });
        axios.get('/account/get-list-profile-percentage').then(function (data) {
          // this.isLoading = false;
          // this.profile = data.data;
          _this3.$emit('pass-data-to-paren', data.data);
        });
      });
    },
    clickStatusTimeNow: function clickStatusTimeNow() {
      this.editExp.expEndTime = this.buildDateTimeNow();
      this.isShowEndTime = !this.isShowEndTime;
    },
    buildDateTimeNow: function buildDateTimeNow() {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-goal.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-goal.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    saveAccountDetail: function saveAccountDetail() {
      ...
      axios.post('/api/update-account-detail', rawData).then(function (data) {
        axios.get('/account/get-list-profile-percentage').then(function (data) {
          ...
          _this.$emit('pass-data-to-paren', data.data); // this.profile = data.data;
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-school.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-school.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    isFutureDateEdit: function isFutureDateEdit(date) {
      var dateStart = new Date(this.editSchool.start_time);
      return date < dateStart;
    },
    isFutureDateCreate: function isFutureDateCreate(date) {
      var dateStart = new Date(this.createSchool.start_time_edu);
      return date < dateStart;
    },
    formatDate: function formatDate(inputDate) {
      var p = inputDate.split(/\D/g);
    ...
    validateForm: function validateForm() {
      ...
      if (this.createSchool.start_time_edu) {
        ...
        var mydate = new Date(this.createSchool.start_time_edu);
      ...
      if (this.createSchool.end_time_edu) {
        ...
        var _mydate = new Date(this.createSchool.end_time_edu);
    ...
    modalCreateSchool: function modalCreateSchool() {
      this.resetInput();
      $('#modal-create-school').modal('show');
    },
    modalEditSchool: function modalEditSchool(item) {
      this.editSchool = item;
      $('#modal-edit-school').modal('show');
    },
    saveEditSchool: function saveEditSchool() {
      var _this = this;
      ...
      this.isLoading = true;
      axios.post('/account/update-account-education/' + this.editSchool.id, rawDataPost).then(function (data) {
        axios.get('/account/get-list-edu').then(function (data) {
          $('#modal-edit-school').modal('hide');
          _this.isLoading = false;
          _this.profile.accountEdu = data.data;
        });
      });
    },
    deleteSchool: function deleteSchool(schoolId) {
      var _this2 = this;

      this.isLoadingDelete = true;
      axios.post('/account/delete-account-education/' + schoolId).then(function (data) {
        axios.get('/account/get-list-edu').then(function (data) {
          $('#modal-edit-school').modal('hide');
          _this2.isLoadingDelete = false;
          _this2.profile.accountEdu = data.data;
        });
      });
    },
    saveSchool: function saveSchool() {
      ...
      this.isLoading = true;
      axios.post('/account/add-account-education/', rawDataPost).then(function (data) {
        axios.get('/account/get-list-edu').then(function (data) {
          $('#modal-create-school').modal('hide');
          _this3.isLoading = false;
          _this3.profile.accountEdu = data.data;
        });
        axios.get('/account/get-list-profile-percentage').then(function (data) {
          _this3.$emit('pass-data-to-paren', data.data); // this.profile = data.data;
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-skill.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-skill.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    resetInputAfterDone: function resetInputAfterDone() {
      this.skill.skill_id = '';
      this.skill.point = '';
      this.errors = {};
    },
    ...
    saveSkill: function saveSkill() {
      ...
      var rawDataInsert = this.skill;
      this.isLoading = true;
      axios.post('/account/add-account-skill', rawDataInsert).then(function (data) {
        axios.get('/account/get-list-profile-percentage').then(function (data) {
          $('#modal-form_ky_nang').modal('hide');
          axios.get('/account/get-list-account-skill').then(function (data) {
            _this.isLoading = false;
            _this.profile.accSkill = data.data;
          }); // this.profile = data.data;
    ...
    deleteSkill: function deleteSkill(id) {
      ...
      this.isLoading = true;
      axios.post('/account/delete-account-skill/' + id).then(function (data) {
        axios.get('/account/get-list-account-skill').then(function (data) {
          _this2.isLoading = false;
          _this2.profile.accSkill = data.data;
        });
      });
    }
  }
...
/*!************************************************************!*\
  !*** ./node_modules/vue-advanced-cropper/dist/index.es.js ***!
  \************************************************************/
/*! exports provided: BoundingBox, CircleStencil, Cropper, DragEvent, DraggableArea, DraggableElement, HandlerWrapper, LineWrapper, MoveEvent, PreviewImage, PreviewResult, RectangleStencil, ResizeEvent, SimpleHandler, SimpleLine */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BoundingBox", function() { return BoundingBox; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CircleStencil", function() { return CircleStencil; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Cropper", function() { return Cropper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DragEvent", function() { return DragEvent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DraggableArea", function() { return DraggableArea; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DraggableElement", function() { return DraggableElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HandlerWrapper", function() { return HandlerWrapper; });
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/avatar.vue?vue&type=template&id=c4d61206&":
/*!******************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/avatar.vue?vue&type=template&id=c4d61206& ***!
  \******************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", { staticClass: "page-flex" }, [
    _c("div", { staticClass: "fixed-top" }, [
      _c("div", { staticClass: "container" }, [
        _c(
          ...
          {
            staticClass:
              "fixed-top__inner fixed-top__inner--flex-end display-flex-wrap"
          },
          [
            _vm.urlRedirect
              ? _c(
                  "div",
                  { staticClass: "fixed-top__block display-flex-wrap" },
                  [
                    _c("div", { staticClass: "fixed-top__img" }),
                    _vm._v(" "),
                    _c("div", { staticClass: "fixed-top__text p-r-0" }, [
                      _c(
                        "div",
                        { staticClass: "fixed-top__head display-flex-wrap" },
                        [
                          _c(
                            "div",
                            { staticClass: "fixed-top__title s-text17 m-r-20" },
                            [_vm._v(_vm._s(_vm.jobRedirect.title))]
                          ),
                          _vm._v(" "),
                          _c(
                            "div",
                            {
                              staticClass:
                                "page-tag page-tag--red mobile-hidden"
                            },
                            [
                              _vm.jobRedirect.job_type == 1
                                ? _c("span", [_vm._v("Toàn thời gian")])
                                : _vm._e(),
                              _vm._v(" "),
                              _vm.jobRedirect.job_type == 2
                                ? _c("span", [_vm._v("Part time")])
                                : _vm._e(),
                              _vm._v(" "),
                              _vm.jobRedirect.job_type == 3
                                ? _c("span", [_vm._v("Hợp đồng")])
                                : _vm._e(),
                              _vm._v(" "),
                              _vm.jobRedirect.job_type == 4
                                ? _c("span", [_vm._v("Mùa vụ")])
                                : _vm._e()
                            ]
                          )
                        ]
                      ...
                      _c(
                        "div",
                        {
                          staticClass: "fixed-top__desc s-text8 mobile-hidden"
                        },
                        [_vm._v(_vm._s(_vm.jobRedirect.name))]
                      )
                    ])
                  ]
                )
            ...
            _c(
              ...
              {
                staticClass:
                  "fixed-top__block fixed-top__block--right display-flex-wrap"
              },
              [
                _c(
                  "div",
                  {
                    staticClass:
                      "page-point page-point--full m-r-20 mobile-hidden",
                  ...
                  [
                    _c(
                      "div",
                      {
                        staticClass: "page-point__item page-point__item--inline"
                      },
                      [
                        _c(
                          "div",
                          { staticClass: "page-point__title s-text9 m-b-7" },
                          [_vm._v("Mức độ hoàn thành:")]
                        ),
                        _vm._v(" "),
                        _c(
                          "div",
                          { staticClass: "page-point__point s-text9" },
                          [
                            _vm._v(
                              "\n                                    " +
                                _vm._s(
                                  Math.round(
                                    _vm.profile["percentageProfile"][
                                      "percentage_profile"
                                    ]
                                  )
                                ) +
                      ...
                      _c(
                        "a",
                        {
                          ...
                          attrs: {
                            disabled: !(
                              _vm.urlRedirect &&
                              _vm.profile["percentageProfile"]["is_pass_apply"]
                            )
                          },
                          on: {
                            click: function($event) {
                              return _vm.btnApplyJob()
                            }
                          }
                        },
                        [_vm._v("Ứng tuyển ngay")]
                      )
                    ])
                  : _vm._e()
              ]
    ...
    _vm._v(" "),
    _c("div", { staticClass: "upload-example mo-m0a" }, [
      _c(
        "div",
        { staticClass: "page-block__img m-m-r-0", attrs: { id: "avatr_show" } },
        [
          _vm.profile["accountDetail"]["avatar"]
            ? _c("img", {
                attrs: { src: _vm.profile["accountDetail"]["avatar"] }
              })
            : _vm._e(),
          _vm._v(" "),
          !_vm.profile["accountDetail"]["avatar"]
    ...
    _vm._v(" "),
    _c("div", { staticClass: "page-block__desc page-block__desc--flex" }, [
      _c(
        "div",
        {
          staticClass:
            "page-block__head page-block__head--full m-tac display-block"
        },
        [
          _c(
            "h4",
            { staticClass: "page-block__title m-text3 m-b-0 m-b-5 m-r-20" },
            [_vm._v(_vm._s(_vm.profile["account"]["name"]))]
          ),
          _vm._v(" "),
          _c("div", { staticClass: "s-text10 m-b-20 m-m-b-10" }, [
            _vm._v(_vm._s(_vm.profile["account"]["email"]))
          ]),
          _vm._v(" "),
          _c(
            "span",
            {
              staticClass: "label-link label-link--no-input",
              on: {
                click: function($event) {
            ...
            [
              ...
              _vm._v("\n\t\t\t\t    Đổi ảnh đại diện"),
              _c("sup", { staticClass: "text-warning" }, [_vm._v("*")])
            ]
          )
        ]
      ),
      _vm._v(" "),
      _c("div", { staticClass: "page-block__info" }, [
        _c("div", [_vm._v(_vm._s(_vm.profile2))]),
        _vm._v(" "),
        _c("div", { staticClass: "form-group" }, [
          _c("div", { staticClass: "display-flex-wrap" }, [
            _c(
              "label",
              { staticClass: "m-r-10", attrs: { for: "job_search_status" } },
              [_vm._v("Trạng thái tìm việc")]
            ),
            _vm._v(" "),
            _vm.isLoading
              ? _c(
                  ...
                  {
                    staticClass:
                      "page-block__saved page-block__saved--active m-b-5"
                  },
                  [
                    _vm._m(1),
                    _vm._v(
          ...
          _c("div", { staticClass: "select-wrapper" }, [
            _c(
                ...
                directives: [
                  {
                    ...
                    rawName: "v-model",
                    value: _vm.statusJob,
                    expression: "statusJob"
                  }
                ],
                staticClass: "chosen-select primary-select mw100",
                attrs: { id: "job_search_status", tabindex: "2" },
                on: {
                  change: [
                    function($event) {
                      ...
                      _vm.statusJob = $event.target.multiple
                        ? $$selectedVal
                        : $$selectedVal[0]
                    },
                    function($event) {
              ...
              _vm._l(_vm.profileStatus, function(item) {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "page-point page-point--full" }, [
          _c("div", { staticClass: "page-point__item" }, [
            _c("div", { staticClass: "page-point__title s-text9 m-b-7" }, [
              _vm._v("Mức độ hoàn thành:")
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "page-point__point s-text9" }, [
              _vm._v(
                "\n                            " +
                  _vm._s(
                    Math.round(
                      _vm.profile["percentageProfile"]["percentage_profile"]
                    )
                  ) +
                  "%\n                        "
              )
    ...
    _c(
      "div",
      {
        ...
        attrs: { id: "modalAvatar", role: "dialog" }
      },
      [
          ...
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-footer" }, [
              _c(
                "button",
                {
                  staticClass: "button-register m-r-10",
              ...
              _c(
                "button",
                { staticClass: "button-primary", on: { click: _vm.crop } },
                [
                  !_vm.isLoading
                    ? _c("span", [
                        _vm._v(
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "page-point__block" }, [
      _c("div", { staticClass: "page-point__progress processBarLoading" })
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        ...
        [_c("i", { staticClass: "icon-close-2" })]
      ),
      _vm._v(" "),
      _c("h4", { staticClass: "modal-title" }, [_vm._v("Cập nhật avatar")])
    ])
  }
]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "page-block m-b-30" }, [
    _vm._m(0),
    _vm._v(" "),
    _vm._m(1),
    _vm._v(" "),
    _c("div", { staticClass: "page-col-4" }, [
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _vm._m(2),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.profile["account"]["name"],
              expression: "profile['account']['name']"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "VD: Nguyen Van A" },
          domProps: { value: _vm.profile["account"]["name"] },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.profile["account"], "name", $event.target.value)
            }
          }
        }),
        _vm._v(" "),
        _vm.errors["name"]
          ? _c("span", { staticClass: "msg-alert" }, [
      ...
      _c(
        "div",
        { staticClass: "form-group m-r-30 m-m-r-0", attrs: { id: "data_1" } },
        [
          _vm._m(3),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "form-control-container date" },
            [
              _c("date-pick", {
                attrs: { displayFormat: "DD-MM-YYYY" },
                model: {
                  value: _vm.profile["accountDetail"]["date_of_birth"],
                  callback: function($$v) {
                    _vm.$set(_vm.profile["accountDetail"], "date_of_birth", $$v)
                  },
                  expression: "profile['accountDetail']['date_of_birth']"
                }
              })
            ],
            1
      ...
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _vm._m(4),
        _vm._v(" "),
        _c("div", { staticClass: "fixed-var" }, [
          _vm._v(
            "\n                    " +
              _vm._s(_vm.profile["account"]["email"]) +
              "\n                "
          )
        ])
      ]),
      ...
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("div", { staticClass: "fixed-var" }, [
          _vm._v(
            "\n                    " +
              _vm._s(_vm.profile["account"]["phone"]) +
              "\n                "
          )
        ])
      ]),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.profile["accountDetail"]["link_fb"],
              expression: "profile['accountDetail']['link_fb']"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Link Facebook" },
          domProps: { value: _vm.profile["accountDetail"]["link_fb"] },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Giới tính")]),
        _vm._v(" "),
        _c("div", { staticClass: "m-checkbox-container" }, [
          _c("label", { staticClass: "m-checkbox p-r-20" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.profile["accountDetail"]["gender"],
                  expression: "profile['accountDetail']['gender']"
                }
              ],
              staticClass: "i-checks",
              attrs: { type: "radio", value: "1" },
              domProps: {
                checked: _vm._q(_vm.profile["accountDetail"]["gender"], "1")
              },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.profile["accountDetail"], "gender", "1")
                }
              }
            }),
            _vm._v("Nam"),
          ...
          _c("label", { staticClass: "m-checkbox p-r-20" }, [
            _c("input", {
              ...
              domProps: {
                checked: _vm._q(_vm.profile["accountDetail"]["gender"], "2")
              },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.profile["accountDetail"], "gender", "2")
                }
              }
            }),
            _vm._v("Nữ"),
          ...
          _c("label", { staticClass: "m-checkbox" }, [
            _c("input", {
              ...
              domProps: {
                checked: _vm._q(_vm.profile["accountDetail"]["gender"], "3")
              },
              on: {
                change: function($event) {
                  return _vm.$set(_vm.profile["accountDetail"], "gender", "3")
                }
              }
            }),
            _vm._v("\n                        Khác"),
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group col-4-2" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Tình trạng hôn nhân")]),
        _vm._v(" "),
        _c("div", { staticClass: "m-checkbox-container" }, [
          _c("label", { staticClass: "m-checkbox p-r-20 m-m-b-10" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.profile["accountDetail"]["marital_status"],
                  expression: "profile['accountDetail']['marital_status']"
                }
              ],
              staticClass: "i-checks",
              attrs: { type: "radio", value: "1" },
              domProps: {
                checked: _vm._q(
                  _vm.profile["accountDetail"]["marital_status"],
                  "1"
                )
              },
              on: {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group col-4-2 m-r-30 m-m-r-0" }, [
        _vm._m(6),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.profile["accountDetail"]["full_address"],
              expression: "profile['accountDetail']['full_address']"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Địa chỉ" },
          domProps: { value: _vm.profile["accountDetail"]["full_address"] },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
        ...
        _vm._v(" "),
        _vm.errors["full_address"]
          ? _c("span", { staticClass: "msg-alert" }, [
              _vm._v(_vm._s(_vm.errors["full_address"]))
            ])
          : _vm._e()
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.profile["accountDetail"]["province_id"],
                  expression: "profile['accountDetail']['province_id']"
                }
              ],
        ...
        _vm.errors["province_id"]
          ? _c("span", { staticClass: "msg-alert" }, [
              _vm._v(_vm._s(_vm.errors["province_id"]))
            ])
          : _vm._e()
      ]),
      _vm._v(" "),
          ...
          _c(
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.profile["accountDetail"]["district_id"],
                  expression: "profile['accountDetail']['district_id']"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
            ...
            [
              ...
              _vm._l(_vm.district, function(item) {
                return _c("option", { domProps: { value: item.districtsId } }, [
                  _vm._v(_vm._s(item.name))
                ])
              })
            ],
    ...
    _vm._v(" "),
    _c("div", { staticClass: "btn-container display-flex-wrap jce" }, [
      _vm.isLoading
        ? _c(
            "div",
            {
              staticClass: "page-block__saved page-block__saved--active m-r-10"
            },
            [_vm._m(9), _vm._v("\n                Đã lưu\n            ")]
          )
        : _vm._e(),
      ...
      _c(
        "button",
        {
          staticClass: "button-primary btn-submit-step1",
          on: {
            click: function($event) {
              return _vm.saveAccountDetail()
            }
          }
        },
        [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "display-flex-wrap m-b-6" }, [
      _c("div", { staticClass: "m-text5 p-r-20" }, [_vm._v("Thông tin cơ bản")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("small", { staticClass: "m-b-20" }, [
      _vm._v("Hoàn thành mục "),
      _c("sup", { staticClass: "text-danger" }, [_vm._v("*")]),
      _vm._v(" để có thể ứng tuyển thành công")
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { staticClass: "m-b-6" }, [
      _vm._v("Họ và tên"),
      _c("sup", [_vm._v("*")])
    ])
  },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-character.vue?vue&type=template&id=773b4911&":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-character.vue?vue&type=template&id=773b4911& ***!
  \*****************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "page-block m-b-30" }, [
    _c("label", { staticClass: "m-text5 m-b-20" }, [_vm._v("Tính cách")]),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        _c("multiselect", {
          attrs: {
            ...
            label: "name",
            "track-by": "name",
            options: _vm.listCharacter,
            multiple: true,
            taggable: false
          },
          on: { input: _vm.saveCharacter },
          model: {
            value: _vm.value,
            callback: function($$v) {
              _vm.value = $$v
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-desire.vue?vue&type=template&id=5772dad2&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-desire.vue?vue&type=template&id=5772dad2&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "page-block m-b-30" }, [
    ...
    _c("div", { staticClass: "page-col-4" }, [
          ...
          _c(
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.desire.filed_work_wish,
                  expression: "desire.filed_work_wish"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
                id: "filed_work_wish",
                name: "filed_work_wish",
            ...
            [
              _c(
                ...
                [_vm._v("Chọn lĩnh vực")]
              ),
              _vm._v(" "),
              _vm._l(_vm.profile["fieldJobs"], function(item) {
                return _c("option", { domProps: { value: item.id } }, [
                  _vm._v(_vm._s(item.name))
                ])
              })
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Vị trí:")]),
        _vm._v(" "),
        _c("div", { staticClass: "select-wrapper" }, [
          _c(
            "select",
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.desire.position_wish,
                  expression: "desire.position_wish"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Loại hình công việc:")]),
        _vm._v(" "),
        _c("div", { staticClass: "select-wrapper" }, [
          _c(
            "select",
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.desire.job_type_wish,
                  expression: "desire.job_type_wish"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
                name: "job_type_wish",
                "data-placeholder": "Loại hình công việc...",
                tabindex: "2"
              },
              on: {
                change: function($event) {
            ...
            [
              _c(
                "option",
                { attrs: { value: "null", disabled: "", selected: "" } },
                [_vm._v("Chọn loại hình")]
              ),
              _vm._v(" "),
              _vm._l(_vm.jobType, function(item) {
                return _c("option", { domProps: { value: item.id } }, [
                  _vm._v(_vm._s(item.name))
                ])
              })
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Mức lương:")]),
        _vm._v(" "),
        _c("div", { staticClass: "select-wrapper" }, [
          _c(
            "select",
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.desire.salary_wish,
                  expression: "desire.salary_wish"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
            ...
            [
              ...
              _vm._v(" "),
              _vm._l(_vm.jobSalary, function(item) {
                return _c("option", { domProps: { value: item.id } }, [
                  _vm._v(_vm._s(item.name))
                ])
              })
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Thành phố/ Tỉnh:")]),
        _vm._v(" "),
        _c("div", { staticClass: "select-wrapper" }, [
          _c(
            "select",
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.desire.province_id,
                  expression: "desire.province_id"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Quận/Huyện:")]),
        _vm._v(" "),
        _c("div", { staticClass: "select-wrapper" }, [
          _c(
            "select",
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.desire.district_id,
                  expression: "desire.district_id"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group m-r-30 m-m-r-0" }, [
        _c("label", { staticClass: "m-b-6" }, [_vm._v("Điều mong muốn:")]),
        _vm._v(" "),
        _c("div", { staticClass: "select-wrapper" }, [
          _c(
            "select",
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.desire.current_priority,
                  expression: "desire.current_priority"
                }
              ],
              staticClass: "chosen-select primary-select",
              attrs: {
                name: "current_priority",
                "data-placeholder": "Điều mong muốn ...",
                tabindex: "2"
              },
              on: {
                change: function($event) {
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "display-flex-wrap m-b-20" }, [
      _c("div", { staticClass: "m-text5 p-r-20" }, [_vm._v("Mong muốn")])
    ])
  },
  function() {
    var _vm = this
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true& ***!
  \***********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "page-block m-b-30" }, [
    _c("div", { staticClass: "display-flex-wrap m-b-6" }, [
      _c("div", { staticClass: "m-text5 p-r-20" }, [
        _vm._v("Kinh nghiệm làm việc")
      ]),
      _vm._v(" "),
      _vm.isLoading
        ? _c(
            "div",
            { staticClass: "page-block__saved page-block__saved--active" },
            [_vm._m(0), _vm._v("\n                Đã lưu\n            ")]
          )
        : _vm._e()
    ]),
    ...
    _c(
      "div",
      {
        ...
        attrs: { id: "list_account_exp" }
      },
      _vm._l(_vm.profile["accountExp"], function(item) {
        return _c(
          "div",
          {
            staticClass: "item-box item-box--has-tool",
            attrs: { id: "account_exp_" }
          },
          [
            _c("div", { staticClass: "item-box__inner" }, [
              _c("div", { staticClass: "item-box__head m-b-15" }, [
                _c("span", { staticClass: "item-box__title s-text7 m-r-20" }, [
                  _vm._v(_vm._s(item["company"]))
                ]),
                _vm._v(" "),
                _c("span", { staticClass: "item-box__date s-text8" }, [
                  _vm._v(
                    _vm._s(_vm.formatDate(item["start_time"])) +
                      " -> " +
                      _vm._s(_vm.formatDate(item["end_time"]))
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "item-box__label s-text11 m-b-5" }, [
                _vm._v(
                  _vm._s(item["position"]) + " - " + _vm._s(item["field_work"])
                )
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "item-box__label s-text11 m-b-5" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "item-box__desc" }, [
            ...
            _c("div", { staticClass: "box-tool" }, [
              _c(
                "div",
                {
                  staticClass: "box-tool__item updateExpAccount",
                  on: {
                    click: function($event) {
                      return _vm.eExp(item)
                    }
                  }
                },
              ...
              _c(
                "div",
                {
                  staticClass: "box-tool__item",
                  on: {
                    click: function($event) {
                      return _vm.deleteExp(item.id)
                    }
                  }
                },
                [
                  !_vm.isLoading
                    ? _c("span", [_c("i", { staticClass: "icon-trash" })])
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.isLoading
                    ? _c("span", [
    ...
    _c(
      "div",
      {
        staticClass: "dotted-button dotted-button--full",
        on: {
          click: function($event) {
            return _vm.clickCreateExp()
          }
        }
      },
      [
        _c("i", { staticClass: "icon-add-2" }),
        _vm._v("Thêm kinh nghiệm làm việc\n        ")
      ]
    ),
    _vm._v(" "),
    _c(
      "div",
      {
        staticClass: "modal fade modal-no-padding",
        attrs: { id: "modal-form-create-exp", "aria-hidden": "true" }
      },
      [
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-body" }, [
              _c("div", { staticClass: "popup-container p-b-25 m-p-20" }, [
                _c("div", { staticClass: "m-text3 m-b-20" }, [
                  _vm._v("Kinh nghiệm làm việc")
                ]),
                _vm._v(" "),
                _c(
                  "form",
                  {
                    attrs: { method: "post", action: "", id: "form_creat_exp" }
                  },
                  [
                    _c("div", { staticClass: "form-group m-b-20" }, [
                      ...
                      _c("div", { staticClass: "select-wrapper" }, [
                        _c(
                          "select",
                          {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.expPosition,
                                expression: "expPosition"
                              }
                            ],
                            staticClass: "chosen-select primary-select",
                            attrs: {
                            ...
                            on: {
                              change: function($event) {
                                ...
                                _vm.expPosition = $event.target.multiple
                                  ? $$selectedVal
                                  : $$selectedVal[0]
                              }
                            }
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _vm._l(_vm.allRank, function(item) {
                              return _c(
                                "option",
                                { domProps: { value: item.id } },
                                [_vm._v(_vm._s(item.name))]
                      ...
                      _vm._v(" "),
                      _vm.errors["expPosition"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["expPosition"]))
                          ])
                        : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group m-b-20" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.expCompany,
                            expression: "expCompany"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                        ...
                        domProps: { value: _vm.expCompany },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.expCompany = $event.target.value
                          }
                        }
                      }),
                      _vm._v(" "),
                      _vm.errors["expCompany"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["expCompany"]))
                          ])
                        : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group m-b-20" }, [
                          ...
                          "select",
                          {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.expFieldWork,
                                expression: "expFieldWork"
                              }
                            ],
                            staticClass: "chosen-select primary-select",
                            attrs: {
                            ...
                            on: {
                              change: function($event) {
                                ...
                                _vm.expFieldWork = $event.target.multiple
                                  ? $$selectedVal
                                  : $$selectedVal[0]
                              }
                            }
                      ...
                      _vm._v(" "),
                      _vm.errors["expFieldWork"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["expFieldWork"]))
                          ])
                        : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c(
                      ...
                      {
                        staticClass:
                          "form-group form-group--half m-b-20 m-r-30",
                        attrs: { id: "data_1" }
                      },
                      [
                        _vm._m(5),
                        ...
                        _c(
                          ...
                          [
                            _c("date-pick", {
                              attrs: { displayFormat: "DD-MM-YYYY" },
                              model: {
                                value: _vm.expStartTime,
                                callback: function($$v) {
                                  _vm.expStartTime = $$v
                                },
                                expression: "expStartTime"
                              }
                            }),
                            _vm._v(" "),
                            _vm.errors["expStartTime"]
                              ? _c("span", { staticClass: "msg-alert" }, [
                                  _vm._v(_vm._s(_vm.errors["expStartTime"]))
                                ])
                              : _vm._e()
                          ],
                          1
                        ...
                        _c("div", {
                          staticClass:
                            "error-create-account-exp error_start_time"
                        })
                      ]
                    ),
                    _vm._v(" "),
                    _vm.isShowEndTime
                      ? _c(
                          ...
                          {
                            staticClass:
                              "form-group form-group--half div_date_end m-b-20"
                          },
                          [
                            _vm._m(6),
                            _vm._v(" "),
                            _c(
                              ...
                              [
                                _c("date-pick", {
                                  ...
                                  model: {
                                    value: _vm.expEndTime,
                                    callback: function($$v) {
                                      _vm.expEndTime = $$v
                                    },
                                    expression: "expEndTime"
                                  }
                                }),
                                _vm._v(" "),
                                _vm.errors["expEndTime"]
                                  ? _c("span", { staticClass: "msg-alert" }, [
                                      _vm._v(_vm._s(_vm.errors["expEndTime"]))
                                    ])
                                  : _vm._e()
                              ],
                              1
                            ...
                            _c("div", {
                              staticClass:
                                "error-create-account-exp error_end_time"
                            })
                          ]
                        )
                      : _vm._e(),
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group m-b-25" }, [
                      _vm._m(7),
                      _vm._v(" "),
                      _c("textarea", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.descriptionJob,
                            expression: "descriptionJob"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                          type: "text",
                          placeholder: "Mô tả công việc trước đây",
                          name: "description_exp",
                          id: "description_exp"
                        },
                        domProps: { value: _vm.descriptionJob },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.descriptionJob = $event.target.value
                          }
                        }
                      }),
                      _vm._v(" "),
                      _c("span", {
                        staticClass:
                          "text-danger notificaiton_phone pull-right text-under-input"
                      }),
                      _vm._v(" "),
                      _vm.errors["descriptionJob"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["descriptionJob"]))
                          ])
                        : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "popup-btn-container tar" }, [
                      _c(
                        "div",
                        {
                          staticClass: "button-primary",
                          attrs: { id: "btnExpAccount" },
                          on: {
                            click: function($event) {
                              return _vm.saveExp()
                            }
    ...
    _c(
      ...
      {
        staticClass: "modal fade modal-no-padding",
        attrs: { id: "modal-form-edit-exp", "aria-hidden": "true" }
      },
      [
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-body" }, [
              _c("div", { staticClass: "popup-container p-b-25 m-p-20" }, [
                ...
                _vm._v(" "),
                _c("form", { attrs: { method: "post", action: "", id: "" } }, [
                  _c("div", { staticClass: "form-group m-b-20" }, [
                    _vm._m(9),
                    _vm._v(" "),
                    _c("div", { staticClass: "select-wrapper" }, [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.editExp.expPosition,
                              expression: "editExp.expPosition"
                            }
                          ],
                          staticClass: "chosen-select primary-select",
                          attrs: {
                    ...
                    _vm._v(" "),
                    _vm.errors["e_expPosition"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["e_expPosition"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "form-group m-b-20" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editExp.expCompany,
                          expression: "editExp.expCompany"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", placeholder: "Công ty" },
                      domProps: { value: _vm.editExp.expCompany },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.errors["e_expCompany"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["e_expCompany"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "form-group m-b-20" }, [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.editExp.expFieldWork,
                              expression: "editExp.expFieldWork"
                            }
                          ],
                          staticClass: "chosen-select primary-select",
                          attrs: {
                    ...
                    _vm._v(" "),
                    _vm.errors["e_expFieldWork"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["e_expFieldWork"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c(
                    "div",
                    {
                      staticClass: "form-group form-group--half m-b-20 m-r-30"
                    },
                    [
                      _vm._m(12),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c("date-pick", {
                            attrs: { displayFormat: "DD-MM-YYYY" },
                            model: {
                              value: _vm.editExp.expStartTime,
                              callback: function($$v) {
                                _vm.$set(_vm.editExp, "expStartTime", $$v)
                              },
                              expression: "editExp.expStartTime"
                            }
                          })
                        ],
                        1
                      ...
                      _vm._v(" "),
                      _vm.errors["e_expStartTime"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["e_expStartTime"]))
                          ])
                        : _vm._e()
                    ]
                  ),
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _c("date-pick", {
                            attrs: {
                              displayFormat: "DD-MM-YYYY",
                              isDateDisabled: _vm.isFutureDateEdit
                            },
                            model: {
                              value: _vm.editExp.expEndTime,
                              callback: function($$v) {
                                _vm.$set(_vm.editExp, "expEndTime", $$v)
                              },
                              expression: "editExp.expEndTime"
                            }
                          })
                        ],
                        1
                      ...
                      _vm._v(" "),
                      _vm.errors["e_expEndTime"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["e_expEndTime"]))
                          ])
                        : _vm._e()
                    ]
                  ),
                  ...
                  _c("div", { staticClass: "form-group m-b-25" }, [
                    ...
                    _c("textarea", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editExp.descriptionJob,
                          expression: "editExp.descriptionJob"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.editExp.descriptionJob },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.errors["e_descriptionJob"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["e_descriptionJob"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("label", { staticClass: "m-b-6" }, [
      _vm._v("Mô tả công việc trước đây"),
      _c("sup", [_vm._v("*")])
    ])
  },
  function() {
    ...
    return _c(
      "div",
      { staticClass: "popup-form-cls", attrs: { "data-dismiss": "modal" } },
      [
        _c("div", { staticClass: "popup-form-cls-inner" }, [
          _c("i", { staticClass: "icon-close-2" })
        ])
      ]
    )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-goal.vue?vue&type=template&id=7659934a&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-goal.vue?vue&type=template&id=7659934a& ***!
  \************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "page-block m-b-30" }, [
    ...
    _c("div", { staticClass: "form-group" }, [
      ...
      _c(
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.profile["accountDetail"]["career_goals"],
              expression: "profile['accountDetail']['career_goals']"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Mục tiêu nghề nghiệp" },
          domProps: { value: _vm.profile["accountDetail"]["career_goals"] },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
        ...
        [
          _vm._v(
            "            " +
              _vm._s(_vm.profile["accountDetail"]["career_goals"]) +
              "\n        "
          )
        ]
      ),
      _vm._v(" "),
      _vm.errors["career_goals"]
        ? _c("span", { staticClass: "msg-alert" }, [
            _vm._v(_vm._s(_vm.errors["career_goals"]))
          ])
        : _vm._e()
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
      _c("label", { staticClass: "m-b-6" }, [_vm._v("Điểm mạnh, điểm yếu")]),
      _vm._v(" "),
      _c(
        "textarea",
        {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.profile["accountDetail"]["strengths_weaknesses"],
              expression: "profile['accountDetail']['strengths_weaknesses']"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Điểm mạnh, điểm yếu" },
          domProps: {
            value: _vm.profile["accountDetail"]["strengths_weaknesses"]
          },
          on: {
        ...
        [
          _vm._v(
            "            " +
              _vm._s(_vm.profile["accountDetail"]["strengths_weaknesses"]) +
              "\n        "
          )
        ]
      )
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group m-b-25" }, [
      _c("label", { staticClass: "m-b-6" }, [_vm._v("Hoạt động ngoại khóa")]),
      _vm._v(" "),
      _c(
        "textarea",
        {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.profile["accountDetail"]["extracurricular_activities"],
              expression:
                "profile['accountDetail']['extracurricular_activities']"
            }
          ],
          staticClass: "form-control",
          attrs: { type: "text", placeholder: "Hoạt động ngoại khóa" },
          domProps: {
            value: _vm.profile["accountDetail"]["extracurricular_activities"]
          },
          on: {
        ...
        [
          _vm._v(
            "            " +
              _vm._s(
                _vm.profile["accountDetail"]["extracurricular_activities"]
              ) +
              "\n        "
          )
        ]
    ...
    _c("div", { staticClass: "btn-container display-flex-wrap jce" }, [
      ...
      _c(
        "button",
        {
          staticClass: "button-primary btn-submit-step2",
          attrs: { type: "submit" },
          on: {
            click: function($event) {
              return _vm.saveAccountDetail()
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-school.vue?vue&type=template&id=41342e3c&scoped=true&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-school.vue?vue&type=template&id=41342e3c&scoped=true& ***!
  \**************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "page-block m-b-30" }, [
    ...
    _c(
      ...
      {
        staticClass:
          "wrapper wrapper-content animated fadeInRight listAccountEdu"
      },
      _vm._l(_vm.profile["accountEdu"], function(item) {
        return _c(
          "div",
          {
            staticClass: "item-box item-box--has-tool",
          ...
          [
            _c("div", { staticClass: "item-box__inner" }, [
              ...
              _c("div", { staticClass: "item-box__label s-text11 m-b-5" }, [
                _vm._v(
                  "\n                    " +
                    _vm._s(item["filed_study"]) +
                    " - " +
                    _vm._s(_vm.degreeEducationRefactor[item["degree"]]) +
                    "\n                "
                )
              ]),
              _vm._v(" "),
            ...
            _vm._v(" "),
            _c("div", { staticClass: "box-tool" }, [
              _c("div", { staticClass: "box-tool__item" }, [
                _c("i", {
                  staticClass: "fa fa-edit",
                  on: {
                    click: function($event) {
                      return _vm.modalEditSchool(item)
                    }
                  }
                })
              ]),
              ...
              _c(
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.deleteSchool(item.id)
                    }
                  }
                },
                [
    ...
    _c(
      ...
      {
        staticClass: "dotted-button dotted-button--full",
        attrs: { "data-toggle": "modal", href: "#modal-form1" },
        on: {
          click: function($event) {
            return _vm.modalCreateSchool()
          }
        }
      },
      [_c("i", { staticClass: "icon-add-2" }), _vm._v("Thêm học vấn/bằng cấp")]
    ),
    _vm._v(" "),
    _c(
      "div",
      {
        staticClass: "modal fade modal-no-padding",
        attrs: { id: "modal-create-school", "aria-hidden": "true" }
      },
      [
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-body" }, [
              _c("div", { staticClass: "popup-container p-b-25 m-p-20" }, [
                ...
                _c(
                  "form",
                  {
                    attrs: { method: "post", id: "formEducation", action: "" }
                  },
                  [
                    _c("div", { staticClass: "form-group m-b-20" }, [
                      _vm._m(2),
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.createSchool["school"],
                            expression: "createSchool['school']"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: { type: "text", placeholder: "Trường học" },
                        domProps: { value: _vm.createSchool["school"] },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group m-b-20" }, [
                      _c("label", { staticClass: "m-b-6" }, [
                        _vm._v("Ngành nghề học")
                      ]),
                      _vm._v(" "),
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.createSchool["filed_study"],
                            expression: "createSchool['filed_study']"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: { type: "text", placeholder: "Ngành nghề học" },
                        domProps: { value: _vm.createSchool["filed_study"] },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                      ...
                      _vm._v(" "),
                      _vm.errors["filed_study"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["filed_study"]))
                          ])
                        : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group m-b-20" }, [
                        ...
                        _c(
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.createSchool.degree,
                                expression: "createSchool.degree"
                              }
                            ],
                            staticClass: "chosen-select primary-select",
                            attrs: {
                          ...
                          [
                            _c(
                              ...
                              [_vm._v("Chọn bằng cấp ")]
                            ),
                            _vm._v(" "),
                            _vm._l(_vm.degreeEducation, function(item) {
                              return _c(
                                "option",
                                { domProps: { value: item.id } },
                                [_vm._v(_vm._s(item.name))]
                      ...
                      _vm.errors["degree"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["degree"]))
                          ])
                        : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "form-group m-b-20" }, [
                      _c("label", { staticClass: "m-b-6" }, [
                        _vm._v("Thành tích trong quá trình học")
                      ]),
                      _vm._v(" "),
                      _c("textarea", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.createSchool.description,
                            expression: "createSchool.description"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                          type: "text",
                          placeholder: "Thành tích trong quá trình học",
                          id: "description_edu",
                          name: "description"
                        },
                        domProps: { value: _vm.createSchool.description },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                    ...
                    _c(
                      "div",
                      {
                        staticClass: "form-group form-group--half m-r-30 m-b-20"
                      },
                      [
                        _vm._m(3),
                        _vm._v(" "),
                        _c(
                          ...
                          [
                            _c("date-pick", {
                              attrs: { displayFormat: "DD-MM-YYYY" },
                              model: {
                                value: _vm.createSchool.start_time_edu,
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.createSchool,
                                    "start_time_edu",
                                ...
                                expression: "createSchool.start_time_edu"
                              }
                            })
                          ],
                          1
                        ...
                        _vm._v(" "),
                        _vm.errors["start_time_edu"]
                          ? _c("span", { staticClass: "msg-alert" }, [
                              _vm._v(_vm._s(_vm.errors["start_time_edu"]))
                            ])
                          : _vm._e()
                      ]
                    ),
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "form-group form-group--half div_date_end m-b-25",
                        attrs: { id: "data_1" }
                      },
                      [
                        _vm._m(4),
                        ...
                        _c(
                          ...
                          [
                            _c("date-pick", {
                              attrs: {
                                displayFormat: "DD-MM-YYYY",
                                isDateDisabled: _vm.isFutureDateCreate
                              },
                              model: {
                                value: _vm.createSchool.end_time_edu,
                                callback: function($$v) {
                                  _vm.$set(
                                    _vm.createSchool,
                                    "end_time_edu",
                                ...
                                expression: "createSchool.end_time_edu"
                              }
                            })
                          ],
                          1
                        ...
                        _vm._v(" "),
                        _vm.errors["end_time_edu"]
                          ? _c("span", { staticClass: "msg-alert" }, [
                              _vm._v(_vm._s(_vm.errors["end_time_edu"]))
                            ])
                          : _vm._e()
                      ]
                    ),
    ...
    _c(
      ...
      {
        staticClass: "modal fade modal-no-padding",
        attrs: { id: "modal-edit-school", "aria-hidden": "true" }
      },
      [
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
              ...
              _c("div", { staticClass: "popup-container p-b-25 m-p-20" }, [
                ...
                _c("form", { attrs: { method: "post", action: "" } }, [
                  _c("div", { staticClass: "form-group m-b-20" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editSchool["school"],
                          expression: "editSchool['school']"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", placeholder: "Trường học" },
                      domProps: { value: _vm.editSchool["school"] },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.errors["edit_school"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["edit_school"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "form-group m-b-20" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editSchool["filed_study"],
                          expression: "editSchool['filed_study']"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", placeholder: "Ngành nghề học" },
                      domProps: { value: _vm.editSchool["filed_study"] },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.errors["edit_filed_study"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["edit_filed_study"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "form-group m-b-20" }, [
                    _c("label", { staticClass: "m-b-6" }, [_vm._v("Bằng cấp")]),
                    _vm._v(" "),
                    _c("div", { staticClass: "select-wrapper" }, [
                      _c(
                        "select",
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.editSchool.degree,
                              expression: "editSchool.degree"
                            }
                          ],
                          staticClass: "chosen-select primary-select",
                          attrs: {
                    ...
                    _vm._v(" "),
                    _vm.errors["edit_degree"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["edit_degree"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "form-group m-b-20" }, [
                    ...
                    _c("textarea", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editSchool.description,
                          expression: "editSchool.description"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.editSchool.description },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.errors["edit_description"]
                      ? _c("span", { staticClass: "msg-alert" }, [
                          _vm._v(_vm._s(_vm.errors["edit_description"]))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _c("date-pick", {
                            attrs: { displayFormat: "DD-MM-YYYY" },
                            model: {
                              value: _vm.editSchool.start_time,
                              callback: function($$v) {
                                _vm.$set(_vm.editSchool, "start_time", $$v)
                              },
                              expression: "editSchool.start_time"
                            }
                          })
                        ],
                        1
                      ...
                      _vm._v(" "),
                      _vm.errors["edit_start_time_edu"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["edit_start_time_edu"]))
                          ])
                        : _vm._e()
                    ]
                  ),
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _c("date-pick", {
                            ...
                            model: {
                              value: _vm.editSchool.end_time,
                              callback: function($$v) {
                                _vm.$set(_vm.editSchool, "end_time", $$v)
                              },
                              expression: "editSchool.end_time"
                            }
                          })
                        ],
                        1
                      ...
                      _vm._v(" "),
                      _vm.errors["edit_end_time_edu"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["edit_end_time_edu"]))
                          ])
                        : _vm._e()
                    ]
                  ),
                  ...
                  _c("div", { staticClass: "popup-btn-container tar" }, [
                    _c(
                      ...
                      {
                        staticClass: "button-primary",
                        attrs: { "data-id": "", type: "submit" },
                        on: {
                          click: function($event) {
                            return _vm.saveEditSchool()
                          }
                        }
                      },
                      [
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", [_vm._v("Thời gian bắt đầu"), _c("sup", [_vm._v("*")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-skill.vue?vue&type=template&id=5882278e&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/profile/profile-skill.vue?vue&type=template&id=5882278e& ***!
  \*************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "page-block m-b-30" }, [
    _c("div", { staticClass: "display-flex-wrap m-b-20" }, [
      _c("div", { staticClass: "m-text5 p-r-20" }, [_vm._v("Kỹ năng")]),
      _vm._v(" "),
      _vm.isLoading
        ? _c(
            "div",
    ...
    _c(
      "div",
      { staticClass: "wrapper wrapper-content animated fadeInRight m-p-r-60" },
      [
        _c(
          "div",
          {
            staticClass: "page-point m-b-20",
            attrs: { id: "list_account_skill" }
          },
          _vm._l(_vm.profile["accSkill"], function(item) {
            return _c(
              "div",
              {
                staticClass: "page-point__item page-point__item--delete m-b-12",
                attrs: { id: "account_skill_" }
              },
              [
                _c("div", { staticClass: "page-point__title s-text9 m-b-7" }, [
                  _vm._v(" " + _vm._s(item["name"]))
                ...
                _vm._v(" "),
                _c("div", { staticClass: "page-point__block" }, [
                  _c("div", {
                    staticClass: "page-point__progress",
                    attrs: { "data-width": item.point }
                  })
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "page-point__delete--hover" }, [
                  _c(
                    "div",
                    {
                      staticClass: "page-point__delete",
                      on: {
                        click: function($event) {
                          return _vm.deleteSkill(item.id)
                        }
                      }
                    },
    ...
    _c(
      ...
      [_c("i", { staticClass: "icon-add-2" }), _vm._v("Thêm kỹ năng\n        ")]
    ),
    _vm._v(" "),
    _c(
      "div",
      {
        staticClass: "modal fade modal-no-padding",
        attrs: { id: "modal-form_ky_nang", "aria-hidden": "true" }
      },
      [
        _c("div", { staticClass: "modal-dialog modal-dialog--center" }, [
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-body" }, [
              _c("div", { staticClass: "popup-container p-b-25 m-p-20" }, [
                _c("div", { staticClass: "m-text3 m-b-20" }, [
                  _vm._v("Kỹ năng ứng viên")
                ]),
                _vm._v(" "),
                _c(
                  "form",
                  ...
                  [
                      ...
                      _c("div", { staticClass: "select-wrapper" }, [
                        _c(
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.skill.skill_id,
                                expression: "skill.skill_id"
                              }
                            ],
                            staticClass: "chosen-select primary-select",
                            attrs: {
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _vm._l(_vm.profile["skill"], function(item) {
                              return _c(
                                "option",
                                { domProps: { value: item.id } },
                    ...
                    _c("div", { staticClass: "form-group m-b-25" }, [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.skill.point,
                            expression: "skill.point"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                          ...
                          min: "0",
                          max: "100",
                          placeholder: "Điểm kỹ năng từ 1 đến 100",
                          id: "point",
                          name: "point"
                        },
                        domProps: { value: _vm.skill.point },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(_vm.skill, "point", $event.target.value)
                          }
                        }
                      }),
                      _vm._v(" "),
                      _vm.errors["point"]
                        ? _c("span", { staticClass: "msg-alert" }, [
                            _vm._v(_vm._s(_vm.errors["point"]))
                          ])
                        : _vm._e(),
                      _vm._v(" "),
                      _c("div", {
                        staticClass: "error-create-skill error_point"
                      })
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "popup-btn-container tar" }, [
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", [_vm._v("Kỹ năng"), _c("sup", [_vm._v("*")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", [_vm._v("Điểm kỹ năng"), _c("sup", [_vm._v("*")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
...
/***/ "./resources/js/profile/avatar.vue":
/*!*****************************************!*\
  !*** ./resources/js/profile/avatar.vue ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _avatar_vue_vue_type_template_id_c4d61206___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./avatar.vue?vue&type=template&id=c4d61206& */ "./resources/js/profile/avatar.vue?vue&type=template&id=c4d61206&");
/* harmony import */ var _avatar_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./avatar.vue?vue&type=script&lang=js& */ "./resources/js/profile/avatar.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _avatar_vue_vue_type_template_id_c4d61206___WEBPACK_IMPORTED_MODULE_0__["render"],
  _avatar_vue_vue_type_template_id_c4d61206___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/avatar.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/avatar.vue?vue&type=script&lang=js&":
/*!******************************************************************!*\
  !*** ./resources/js/profile/avatar.vue?vue&type=script&lang=js& ***!
  \******************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/profile/avatar.vue?vue&type=template&id=c4d61206&":
/*!************************************************************************!*\
  !*** ./resources/js/profile/avatar.vue?vue&type=template&id=c4d61206& ***!
  \************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_avatar_vue_vue_type_template_id_c4d61206___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./avatar.vue?vue&type=template&id=c4d61206& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/avatar.vue?vue&type=template&id=c4d61206&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_avatar_vue_vue_type_template_id_c4d61206___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_avatar_vue_vue_type_template_id_c4d61206___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/profile/profile-base.vue":
/*!***********************************************!*\
  !*** ./resources/js/profile/profile-base.vue ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_base_vue_vue_type_template_id_11aaa1ce_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true& */ "./resources/js/profile/profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true&");
/* harmony import */ var _profile_base_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-base.vue?vue&type=script&lang=js& */ "./resources/js/profile/profile-base.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _profile_base_vue_vue_type_template_id_11aaa1ce_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _profile_base_vue_vue_type_template_id_11aaa1ce_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "11aaa1ce",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/profile-base.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/profile-base.vue?vue&type=script&lang=js&":
/*!************************************************************************!*\
  !*** ./resources/js/profile/profile-base.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_base_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-base.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-base.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_base_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/profile/profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true&":
/*!******************************************************************************************!*\
  !*** ./resources/js/profile/profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true& ***!
  \******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_base_vue_vue_type_template_id_11aaa1ce_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-base.vue?vue&type=template&id=11aaa1ce&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_base_vue_vue_type_template_id_11aaa1ce_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_base_vue_vue_type_template_id_11aaa1ce_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/profile/profile-character.vue":
/*!****************************************************!*\
  !*** ./resources/js/profile/profile-character.vue ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_character_vue_vue_type_template_id_773b4911___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-character.vue?vue&type=template&id=773b4911& */ "./resources/js/profile/profile-character.vue?vue&type=template&id=773b4911&");
/* harmony import */ var _profile_character_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-character.vue?vue&type=script&lang=js& */ "./resources/js/profile/profile-character.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _profile_character_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _profile_character_vue_vue_type_template_id_773b4911___WEBPACK_IMPORTED_MODULE_0__["render"],
  _profile_character_vue_vue_type_template_id_773b4911___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/profile-character.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/profile-character.vue?vue&type=script&lang=js&":
/*!*****************************************************************************!*\
  !*** ./resources/js/profile/profile-character.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_character_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-character.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-character.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_character_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/profile/profile-character.vue?vue&type=template&id=773b4911&":
/*!***********************************************************************************!*\
  !*** ./resources/js/profile/profile-character.vue?vue&type=template&id=773b4911& ***!
  \***********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_character_vue_vue_type_template_id_773b4911___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-character.vue?vue&type=template&id=773b4911& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-character.vue?vue&type=template&id=773b4911&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_character_vue_vue_type_template_id_773b4911___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_character_vue_vue_type_template_id_773b4911___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/profile/profile-desire.vue":
/*!*************************************************!*\
  !*** ./resources/js/profile/profile-desire.vue ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_desire_vue_vue_type_template_id_5772dad2_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-desire.vue?vue&type=template&id=5772dad2&scoped=true& */ "./resources/js/profile/profile-desire.vue?vue&type=template&id=5772dad2&scoped=true&");
/* harmony import */ var _profile_desire_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-desire.vue?vue&type=script&lang=js& */ "./resources/js/profile/profile-desire.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _profile_desire_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _profile_desire_vue_vue_type_template_id_5772dad2_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _profile_desire_vue_vue_type_template_id_5772dad2_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "5772dad2",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/profile-desire.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/profile-desire.vue?vue&type=script&lang=js&":
/*!**************************************************************************!*\
  !*** ./resources/js/profile/profile-desire.vue?vue&type=script&lang=js& ***!
  \**************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_desire_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-desire.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-desire.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_desire_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/profile/profile-desire.vue?vue&type=template&id=5772dad2&scoped=true&":
/*!********************************************************************************************!*\
  !*** ./resources/js/profile/profile-desire.vue?vue&type=template&id=5772dad2&scoped=true& ***!
  \********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_desire_vue_vue_type_template_id_5772dad2_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-desire.vue?vue&type=template&id=5772dad2&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-desire.vue?vue&type=template&id=5772dad2&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_desire_vue_vue_type_template_id_5772dad2_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_desire_vue_vue_type_template_id_5772dad2_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/profile/profile-exp.vue":
/*!**********************************************!*\
  !*** ./resources/js/profile/profile-exp.vue ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_exp_vue_vue_type_template_id_d84acbf6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true& */ "./resources/js/profile/profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true&");
/* harmony import */ var _profile_exp_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-exp.vue?vue&type=script&lang=js& */ "./resources/js/profile/profile-exp.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _profile_exp_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _profile_exp_vue_vue_type_template_id_d84acbf6_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _profile_exp_vue_vue_type_template_id_d84acbf6_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "d84acbf6",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/profile-exp.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/profile-exp.vue?vue&type=script&lang=js&":
/*!***********************************************************************!*\
  !*** ./resources/js/profile/profile-exp.vue?vue&type=script&lang=js& ***!
  \***********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_exp_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-exp.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-exp.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_exp_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/profile/profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/profile/profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true& ***!
  \*****************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_exp_vue_vue_type_template_id_d84acbf6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-exp.vue?vue&type=template&id=d84acbf6&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_exp_vue_vue_type_template_id_d84acbf6_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_exp_vue_vue_type_template_id_d84acbf6_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/profile/profile-goal.vue":
/*!***********************************************!*\
  !*** ./resources/js/profile/profile-goal.vue ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_goal_vue_vue_type_template_id_7659934a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-goal.vue?vue&type=template&id=7659934a& */ "./resources/js/profile/profile-goal.vue?vue&type=template&id=7659934a&");
/* harmony import */ var _profile_goal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-goal.vue?vue&type=script&lang=js& */ "./resources/js/profile/profile-goal.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _profile_goal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _profile_goal_vue_vue_type_template_id_7659934a___WEBPACK_IMPORTED_MODULE_0__["render"],
  _profile_goal_vue_vue_type_template_id_7659934a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/profile-goal.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/profile-goal.vue?vue&type=script&lang=js&":
/*!************************************************************************!*\
  !*** ./resources/js/profile/profile-goal.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_goal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-goal.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-goal.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_goal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/profile/profile-goal.vue?vue&type=template&id=7659934a&":
/*!******************************************************************************!*\
  !*** ./resources/js/profile/profile-goal.vue?vue&type=template&id=7659934a& ***!
  \******************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_goal_vue_vue_type_template_id_7659934a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-goal.vue?vue&type=template&id=7659934a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-goal.vue?vue&type=template&id=7659934a&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_goal_vue_vue_type_template_id_7659934a___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_goal_vue_vue_type_template_id_7659934a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/profile/profile-school.vue":
/*!*************************************************!*\
  !*** ./resources/js/profile/profile-school.vue ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_school_vue_vue_type_template_id_41342e3c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-school.vue?vue&type=template&id=41342e3c&scoped=true& */ "./resources/js/profile/profile-school.vue?vue&type=template&id=41342e3c&scoped=true&");
/* harmony import */ var _profile_school_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-school.vue?vue&type=script&lang=js& */ "./resources/js/profile/profile-school.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _profile_school_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _profile_school_vue_vue_type_template_id_41342e3c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _profile_school_vue_vue_type_template_id_41342e3c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "41342e3c",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/profile-school.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/profile-school.vue?vue&type=script&lang=js&":
/*!**************************************************************************!*\
  !*** ./resources/js/profile/profile-school.vue?vue&type=script&lang=js& ***!
  \**************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_school_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-school.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-school.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_school_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/profile/profile-school.vue?vue&type=template&id=41342e3c&scoped=true&":
/*!********************************************************************************************!*\
  !*** ./resources/js/profile/profile-school.vue?vue&type=template&id=41342e3c&scoped=true& ***!
  \********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_school_vue_vue_type_template_id_41342e3c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-school.vue?vue&type=template&id=41342e3c&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-school.vue?vue&type=template&id=41342e3c&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_school_vue_vue_type_template_id_41342e3c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_school_vue_vue_type_template_id_41342e3c_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/profile/profile-skill.vue":
/*!************************************************!*\
  !*** ./resources/js/profile/profile-skill.vue ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _profile_skill_vue_vue_type_template_id_5882278e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./profile-skill.vue?vue&type=template&id=5882278e& */ "./resources/js/profile/profile-skill.vue?vue&type=template&id=5882278e&");
/* harmony import */ var _profile_skill_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-skill.vue?vue&type=script&lang=js& */ "./resources/js/profile/profile-skill.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _profile_skill_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _profile_skill_vue_vue_type_template_id_5882278e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _profile_skill_vue_vue_type_template_id_5882278e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/profile/profile-skill.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/profile/profile-skill.vue?vue&type=script&lang=js&":
/*!*************************************************************************!*\
  !*** ./resources/js/profile/profile-skill.vue?vue&type=script&lang=js& ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_skill_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-skill.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-skill.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_skill_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/profile/profile-skill.vue?vue&type=template&id=5882278e&":
/*!*******************************************************************************!*\
  !*** ./resources/js/profile/profile-skill.vue?vue&type=template&id=5882278e& ***!
  \*******************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_skill_vue_vue_type_template_id_5882278e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./profile-skill.vue?vue&type=template&id=5882278e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/profile/profile-skill.vue?vue&type=template&id=5882278e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_skill_vue_vue_type_template_id_5882278e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_profile_skill_vue_vue_type_template_id_5882278e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _avatar_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./avatar.vue */ "./resources/js/profile/avatar.vue");
/* harmony import */ var _profile_base_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-base.vue */ "./resources/js/profile/profile-base.vue");
/* harmony import */ var _profile_goal_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./profile-goal.vue */ "./resources/js/profile/profile-goal.vue");
/* harmony import */ var _profile_character_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./profile-character.vue */ "./resources/js/profile/profile-character.vue");
/* harmony import */ var _profile_exp_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./profile-exp.vue */ "./resources/js/profile/profile-exp.vue");
/* harmony import */ var _profile_skill_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./profile-skill.vue */ "./resources/js/profile/profile-skill.vue");
/* harmony import */ var _profile_school_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./profile-school.vue */ "./resources/js/profile/profile-school.vue");
/* harmony import */ var _profile_desire_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./profile-desire.vue */ "./resources/js/profile/profile-desire.vue");
...
var app = new Vue({
  el: '#profile',
  components: {
    Avatar: _avatar_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    ProfileBase: _profile_base_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    ProfileGold: _profile_goal_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    ProfileCharacter: _profile_character_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    ProfileExp: _profile_exp_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    ProfileSkill: _profile_skill_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    ProfileSchool: _profile_school_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    ProfileDesire: _profile_desire_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  data: function data() {
    return {
      isLoading: true,
  ...
  methods: {
    passDataToParent: function passDataToParent(item) {
      this.profile.percentageProfile = item;
    },
    fetchAllProfile: function fetchAllProfile() {
      var _this = this;

      this.isLoading = true;
      axios.get('/api/update-detail-api').then(function (data) {
        // console.log('data default', data.data);
        // console.log('=====?????===========');
        _this.isLoading = false;
        _this.profile.accountDetail = data.data.accountDetail;
        _this.profile.districts = data.data.districts;
      });
    },
    fetchAllProfileExp: function fetchAllProfileExp() {
      var _this2 = this;

      axios.get('/account/get-list-exp').then(function (data) {
        _this2.profile.accountExp = data.data; // this.isLoading = false;
        // this.profile = data.data;
      });
    },
    fetchAllProfileEdu: function fetchAllProfileEdu() {
      var _this3 = this;
    ...
    fetchAllProfileAccountWish: function fetchAllProfileAccountWish() {
      var _this4 = this;

      axios.get('/account/get-list-account-wish').then(function (data) {
        _this4.isLoadingDesire = false;
        _this4.profile.accountWish = data.data.accountWish;
        _this4.profile.districtsAccountWish = data.data.districtsAccountWish; // this.profile.accountEdu = data.data;
      });
    },
    fetchAllProfilePercentage: function fetchAllProfilePercentage() {
      var _this5 = this;

      axios.get('/account/get-list-profile-percentage').then(function (data) {
        _this5.profile.percentageProfile = data.data;
        _this5.isLoadingPercentageProfile = false; // this.profile.accountEdu = data.data;
      });
    },
    fetchAllSkill: function fetchAllSkill() {
      ...
      axios.get('/account/get-list-all-skill').then(function (data) {
        _this6.profile.skill = data.data; // this.profile.accountEdu = data.data;
      });
    },
    fetchSkillCharactor: function fetchSkillCharactor() {
      var _this7 = this;

      axios.get('/account/get-list-account-skill').then(function (data) {
        _this7.profile.accSkill = data.data;
      });
    },
    fetchAllCharactor: function fetchAllCharactor() {
      ...
      axios.get('/account/get-list-all-character').then(function (data) {
        _this8.profile.characters = data.data; // this.profile.accountEdu = data.data;
      });
    },
    fetchProfileCharacter: function fetchProfileCharacter() {
      var _this9 = this;

      axios.get('/account/get-profile-character').then(function (data) {
        _this9.isLoadingCharactor = false;
        _this9.profile.accCharacter = data.data; // this.profile.accountEdu = data.data;
      });
    },
    fetchListProvince: function fetchListProvince() {
      var _this10 = this;

      axios.get('/account/get-list-province').then(function (data) {
        _this10.profile.provinces = data.data; // this.profile.accountEdu = data.data;
      });
    },
    fetchProfileAccount: function fetchProfileAccount() {
      var _this11 = this;

      axios.get('/account/get-account').then(function (data) {
        _this11.profile.account = data.data; // this.profile.accountEdu = data.data;
      });
    },
    fetchAllFieldJob: function fetchAllFieldJob() {
      ...
      axios.get('/account/get-all-filed-job').then(function (data) {
        _this12.profile.fieldJobs = data.data; // this.profile.accountEdu = data.data;
      });
    },
    getAllProfile: function getAllProfile() {}
  }
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\samacom\samacom\resources\js\profile\profile.js */"./resources/js/profile/profile.js");
