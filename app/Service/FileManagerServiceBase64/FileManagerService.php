<?php
namespace App\Service\FileManagerServiceBase64;
...
class FileManagerService
{
    ...
    {
        $pathFileServer = $this->richFileService->handle($this->getService(), $this->getUserId(), $this->file, $this->generateFileName());
    ...
    public function getRawDataFile($pathFileServer)
    {
        return [
            ...
            'type_file' => $this->getTypeFile('png'),
        ];
    }
